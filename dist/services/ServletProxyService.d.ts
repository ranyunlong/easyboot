...
export declare class ServletProxyService extends ServletService {
    options: ProxyTable;
    _proxy: httpProxy;
    constructor(options: ProxyTable);
    onBeforeController(metadata: ServiceMetadata): Promise<void>;
    proxyTable(context: ServletContext): Promise<void>;
    proxy(path: string, context: ServletContext, proxyOptions: ProxyOptions): Promise<{}>;
}
