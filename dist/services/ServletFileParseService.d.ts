...
export declare class ServletFileParseService extends ServletService {
    opts: Options;
    constructor(opts?: Options);
    onLaunch(metadata: ServiceMetadata<MetadataFile>): Promise<null | undefined | object>;
    parse(context: ServletContext, metadata: MetadataFile): Promise<object>;
}
interface Options {
    /**
