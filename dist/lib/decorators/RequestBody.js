...
function RequestBody(...args) {
    function decorator(target, propertyKey, parameterIndex) {
        ...
        if (args.length === 2) {
            Reflect.defineMetadata(enums_1.MetadataEnums.Controller.REQUEST_BODY, {
            ...
            if (typeof key === 'string') {
                ...
                if (Array.isArray(key)) {
                    const error = new StackTrace_1.StackTrace(`Invalid fields in ${chalk_1.default.yellowBright('@RequestBody')} decorator`);
