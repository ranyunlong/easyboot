...
export declare class Context {
     ...
     */
    constructor(req: IncomingMessage | Http2ServerRequest, res: ServerResponse | Http2ServerResponse, request: Request, response: Response, app: Server);
    [COOKIES]: Cookies;
    session: any;
    respond: boolean;
    /**
    ...
    */
     ...
     * Get request socket
     */
    readonly socket: import("net").Socket | import("tls").TLSSocket;
    /**
     * @property subdomains
