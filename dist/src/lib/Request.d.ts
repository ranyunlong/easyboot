...
export declare class Request {
    ...
    ctx: Context;
    response: Response;
    constructor(req: IncomingMessage, res: ServerResponse, app: TkServer);
    /**
     * @property subdomains
...
export declare function RequestParam(Entity: EntityConstructor): ParameterDecorator;
export declare function RequestBody(Entity: EntityConstructor): ParameterDecorator;
